    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-12">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center -space-x-1 mb-3 sm:mb-4">
                    <img src="assets/images/zic_logo_black.png" alt="ZEGNEN Logo" class="h-8 sm:h-10 w-auto">
                    <h3 class="text-2xl sm:text-3xl font-bold text-gray-900">ZEGNEN</h3>
                </div>
                <p class="text-gray-800 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="hidden sm:block space-y-3 sm:space-y-4">
                    <a href="#" class="flex items-center text-gray-800 hover:text-gray-900 font-medium transition-colors duration-300 text-sm sm:text-base">
                ...
                <div class="sm:hidden overflow-x-auto scrollbar-hide -mx-4 px-4">
                    <div class="flex gap-3 pb-2" style="scroll-snap-type: x mandatory;">
                        <a href="#" class="flex flex-col items-center justify-center bg-white bg-opacity-20 hover:bg-opacity-30 rounded-xl p-4 transition-all duration-300 flex-shrink-0" style="width: 80px; scroll-snap-align: start;">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-6 lg:space-y-0">
                ...
                <div class="flex flex-col space-y-3 sm:space-y-4 w-full lg:w-auto">
                    <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                        <span class="text-gray-800 text-xs sm:text-sm">©2025 ZEGNEN</span>
                ...
                <div class="w-full lg:w-auto lg:text-right">
                    <p class="text-gray-800 text-sm sm:text-base font-medium">ZEGNEN International Company</p>
