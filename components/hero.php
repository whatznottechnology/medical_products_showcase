...
function getHeroSection() {
    ob_start();
?>
<main class="relative z-10 min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-12 pt-20 pb-8">
    <div class="max-w-6xl">
        <!-- Main Heading -->
        <h1 class="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light leading-tight mb-2 sm:mb-3">
            Healthcare Excellence,
        </h1>
        <h2 class="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight mb-4 sm:mb-6">
            Hello ZEGNEN.
        </h2>

        <!-- Subtitle -->
        <div class="text-white text-sm sm:text-base lg:text-lg font-light space-y-0.5 mb-4 sm:mb-6 max-w-2xl">
