    ...
    <section class="relative overflow-hidden" style="height: 80vh;">
        ...
        <div class="absolute inset-0">
            <video 
                ...
                <source src="<?php echo $baseUrl; ?>assets/images/contact_us.mp4" type="video/mp4">
            </video>
        ...
        <div class="container mx-auto px-6 lg:px-12">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-7xl mx-auto">
                ...
                <div class="space-y-4 lg:space-y-6">
                    <!-- Main Office -->
                    <div class="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center shadow-md">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-3">Main Office</h3>
                                <div class="space-y-1.5">
                                    <p class="text-sm lg:text-base text-gray-700 font-medium">Padima, Saripur, Digha</p>
                                    <p class="text-sm lg:text-base text-gray-600">Purba Medinipur - 721428</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center shadow-md">
                                    <svg class="w-6 h-6 lg:w-7 lg:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-3">Branch Offices</h3>
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="flex items-center space-x-2">
                                        <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                                        <span class="text-sm lg:text-base text-gray-700">Kolkata</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                                        <span class="text-sm lg:text-base text-gray-700">Patna</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                                        <span class="text-sm lg:text-base text-gray-700">Odisha</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                                        <span class="text-sm lg:text-base text-gray-700">Siliguri</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-green-400 to-green-600 rounded-xl flex items-center justify-center shadow-md">
                                    <svg class="w-6 h-6 lg:w-7 lg:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                    </svg>
                                </div>
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-3">Contact Numbers</h3>
                                <div class="space-y-2.5">
                                    <?php if (getSetting('call_number')): ?>
                                    <a href="<?php echo getPhoneUrl(); ?>" class="flex items-center text-gray-700 hover:text-yellow-600 transition-colors group">
                                        <svg class="w-4 h-4 mr-2 text-gray-500 group-hover:text-yellow-600" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                                        </svg>
                                        <span class="text-sm lg:text-base font-medium"><?php echo htmlspecialchars(getSetting('call_number')); ?></span>
                                    </a>
                                    <?php endif; ?>
                                    <?php if (getSetting('whatsapp_number')): ?>
                                    <a href="<?php echo getWhatsAppUrl('Hello! I would like to inquire about your CSSD products.'); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center text-green-600 hover:text-green-700 transition-colors group">
                                        ...
                                        <span class="text-sm lg:text-base font-medium">+<?php echo htmlspecialchars(getSetting('whatsapp_number')); ?></span>
                                    </a>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl flex items-center justify-center shadow-md">
                                    <svg class="w-6 h-6 lg:w-7 lg:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    </svg>
                                </div>
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-3">Email Address</h3>
                                <?php if (getSetting('email')): ?>
                                <a href="<?php echo getEmailUrl('Inquiry about ZEGNEN CSSD Products'); ?>" class="text-sm lg:text-base text-gray-700 hover:text-yellow-600 transition-colors break-all font-medium">
                    ...
                    <div class="bg-white p-6 lg:p-8 rounded-2xl shadow-lg border border-gray-100">
                        <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-4">Connect With Us</h3>
                        <div class="flex flex-wrap gap-3">
                            <?php if (hasSocialLink(getSetting('facebook_url'))): ?>
                            <a href="<?php echo htmlspecialchars(getSetting('facebook_url')); ?>" target="_blank" rel="noopener noreferrer" class="w-11 h-11 lg:w-12 lg:h-12 bg-blue-600 hover:bg-blue-700 rounded-lg text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" aria-label="Facebook">
                            ...
                            <a href="<?php echo htmlspecialchars(getSetting('twitter_url')); ?>" target="_blank" rel="noopener noreferrer" class="w-11 h-11 lg:w-12 lg:h-12 bg-blue-400 hover:bg-blue-500 rounded-lg text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" aria-label="Twitter">
                                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.054 10.054 0 01-3.127 1.184 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
                            </a>
                            <?php endif; ?>
                            <?php if (hasSocialLink(getSetting('youtube_url'))): ?>
                            <a href="<?php echo htmlspecialchars(getSetting('youtube_url')); ?>" target="_blank" rel="noopener noreferrer" class="w-11 h-11 lg:w-12 lg:h-12 bg-red-600 hover:bg-red-700 rounded-lg text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" aria-label="YouTube">
                                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M21.593 7.203a2.506 2.506 0 00-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.44a2.56 2.56 0 00-1.766 1.778c-.44 1.61-.44 4.976-.44 4.976s0 3.366.44 4.976c.243.877.909 1.534 1.766 1.778 1.582.448 7.831.448 7.831.448s6.264 0 7.831-.448a2.51 2.51 0 001.767-1.778c.44-1.61.44-4.976.44-4.976s0-3.366-.44-4.976zM9.998 15.505V10.49l5.227 2.507-5.227 2.507z"/></svg>
                            </a>
                            <?php endif; ?>
                            <?php if (hasSocialLink(getSetting('instagram_url'))): ?>
                            <a href="<?php echo htmlspecialchars(getSetting('instagram_url')); ?>" target="_blank" rel="noopener noreferrer" class="w-11 h-11 lg:w-12 lg:h-12 bg-pink-600 hover:bg-pink-700 rounded-lg text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" aria-label="Instagram">
                                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                            </a>
                            <?php endif; ?>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-6 lg:px-12">
            ...
            <div class="rounded-xl overflow-hidden shadow-lg h-96">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3708.8703552202455!2d87.49181607416287!3d21.629974980174044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1ccd0a1b566197%3A0xa925060c955ba937!2sKAMINI%20APPERMENT!5e0!3m2!1sen!2sin!4v1762604394458!5m2!1sen!2sin" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </section>
</main>
